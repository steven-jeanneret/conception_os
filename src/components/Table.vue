  ...
  <div>
    ...
    <div class="col-6">
      <div :style="{width: sizeT}">
        <arrow v-for="i in slice(v1.length)" :key="i" class="element" :nb-array="0" :index="i" :parallel="parallel"/>
      </div>
    </div>
    <div class="col-6">
      <div class="my-2 table_container border border-primary" :style="{width: sizeT}">
    ...
    <div class="col-6">
      <div :style="{width: sizeT}">
        <arrow v-for="i in slice(v1.length)" :key="i" class="element" :nb-array="1" :index="i" :parallel="parallel"/>
      </div>
    </div>
    <div class="col-6">
      <div class="my-2 table_container border border-primary" :style="{width: sizeT}" v-show="show2[0]">
        <div v-for="i in slice(v1.length)" :key="i" class="element">
          <cell :key="i" :value="v1[i] + v2[i]" v-show="show2[i]" :nb-array="2" :index="i"/>
        </div>
      </div>
    </div>
    <div class="col-6">
